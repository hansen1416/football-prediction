...
def big_table(metrics_table):
    ...
    # plt.show()
    plt.tight_layout()
    pic_path = os.path.join("charts", "classification_metrics.png")
    plt.savefig(pic_path, dpi=1000)

    logger.info("chart saved to {}".format(pic_path))


def league_comparison(metrics_table):
    """
    compare accuracy score and f1 score on difference leagues
    """
    ...
    plt.legend()
    # plt.tight_layout()
    pic_path = os.path.join("charts", "league_comparison.jpg")
    plt.savefig(pic_path, bbox_inches='tight', dpi=1000)

    logger.info("chart saved to {}".format(pic_path))


def league_elo_comparison(metrics_table):
    """
    compare leagues with and without ELO
    """
    # compare leagure data
    ...
    plt.legend()
    # plt.tight_layout()
    pic_path = os.path.join("charts", "league_elo_comparison.png")
    plt.savefig(pic_path, bbox_inches='tight', dpi=1000)

    logger.info("chart saved to {}".format(pic_path))


def elo_comparison(metrics_table_num):
    """
    compare results with and without ELO
    """
    ...
    plt.legend()
    # plt.tight_layout()
    pic_path = os.path.join("charts", "elo_comparison.png")
    plt.savefig(pic_path, bbox_inches='tight', dpi=1000)
